...
$tituloPagina             = "Listagem de Grandezas";
$descricaoPagina          = "Informações de grandeza";
$tituloFormulario1        = "Tabela com listagem de Grandezas";
$descricaoFormulario1     = "Dados de identificação de grandeza";
$tituloImpressao          = "Relatório de grandezas cadastradas no sistema DELFOS";
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Grandezas</a>
          </li>
        </ul>
      </div>
    </div>
            ...
            <div class="app-datatable-default overflow-auto">
              ...
              <!-- <table id="table_modelo_01" class="display app-data-table default-data-table"> -->
                <table id="table_listar" class="table table-striped display app-data-table">
                  ...
                  <tbody>
                    <?php
                    foreach ($rsGrandezas as $kObj => $vObj) {
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/bsc/grandeza/listar.js"></script>