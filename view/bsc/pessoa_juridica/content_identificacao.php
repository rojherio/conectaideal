...
$stmt->bindValue(1, $id);
$stmt->execute();
$rsRegistro1 = $stmt->fetch(PDO::FETCH_ASSOC);
if (!($rsRegistro1)) {
  $id = 0;
  $rsRegistro1 = array();
  $rsRegistro1['id'] = 0;
  $rsRegistro1['status'] = 1;
  $rsRegistro1['tipo'] = 2;
  $rsRegistro1['nome'] = '';
  $rsRegistro1['nome_social'] = '';
  $rsRegistro1['cpf'] = '';
  $rsRegistro1['ie'] = '';
  $rsRegistro1['dt_criacao'] = '';
}
//Identiicação - END
...
<input type="hidden" name="p_id" id="p_id" value="<?= $rsRegistro1['id'] ;?>">
<div class="row">
  <div class="col-md-12">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="row">
          <?= createInput(array(
            ...
            /*string*/    'value'       => $rsRegistro1['nome_social'],
            /*bool*/      'required'    => false,
            /*string*/    'prop'        => ''
          )) ;?>
          <?= createInput(array(
        ...
        <div class="row">
          ...
          <?= createInputDate(array(
            ...
            /*string*/    'value'       => $rsRegistro1['dt_criacao'],
            /*bool*/      'required'    => false,
            /*string*/    'prop'        => ''
          )) ;?>
        </div>
        ...
        <div class="card-body">
          ...
          <div class="row">
            <?= createCheckbox(array(
              ...
              /*string*/    'class'       => 'toggle',
              /*string*/    'value'       => 1,
              /*string*/    'checked'     => $rsRegistro1['status'],
              /*string*/    'prop'        => ''
            )) ;?>
          </div>
          <!-- div row input - END -->
