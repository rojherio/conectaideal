...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_unidade_medida" name="form_unidade_medida" method="post" urltosend="bsc/unidade_medida/salvar_identificacao" action="">
      <?php 
      include_once ('view/bsc/unidade_medida/content_identificacao.php'); 
      ?>
    </form>
