...
$tituloImpressao          = "Relatório de tipos de contas bancárias cadastradas no sistema conectaideal";
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/bsc/banco_conta_tipo/listar.js"></script>