...
if (empty($id)) {
  header('Location: '.PORTAL_URL.'view/bsc/banco_conta_tipo/listar');
}
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/bsc/banco_conta_tipo/visualizar.js"></script>