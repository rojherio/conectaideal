...
$tituloPagina             = "Listagem de Niveis de Ensino";
$descricaoPagina          = "Informações de niveis de ensino";
$tituloFormulario1        = "Tabela com listagem de Niveis de Ensino";
$descricaoFormulario1     = "Dados de identificação de niveis de ensino";
$tituloImpressao          = "Relatório de niveis de ensino cadastradas no sistema DELFOS";
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Niveis de Ensino</a>
          </li>
        </ul>
      </div>
    </div>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/bsc/nivel_ensino/listar.js"></script>