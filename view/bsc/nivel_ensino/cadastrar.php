...
$tituloPagina             = "Cadastro do Nivel de Ensino";
$descricaoPagina          = "Informações do nivel de ensino";
$tituloFormulario1        = "Dados do Nivel de Ensino";
$descricaoFormulario1     = "Dados da identificação do nivel de ensino";
$tituloFormulario2        = "";
...
$descricaoFormulario5     = "Defina se esse cadastro de nivel de ensino está ativo ou inativo";
...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_nivel_ensino" name="form_nivel_ensino" method="post" action="">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row">
                <?= createInput(array(
                  /*int 1-12*/  'col'         => 12,
                  /*string*/    'label'       => 'Nome da Nivel de Ensino',
                  /*string*/    'type'        => 'text',
                  /*string*/    'name'        => 'ne_nome',
                  /*string*/    'id'          => 'ne_nome',
                  ...
                  /*int*/       'minlength'   => 3,
                  /*int*/       'maxlength'   => 254,
                  /*string*/    'placeholder' => 'Digite o nome da Nivel de Ensino',
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/bsc/nivel_ensino/cadastrar.js"></script>