...
if (empty($id)) {
  header('Location: '.PORTAL_URL.'view/bsc/exige_registro/listar');
}
            ...
            <div class="app-datatable-default overflow-auto">
              ...
              <table id="table_visualizar" class="table table-striped display app-data-table">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>Exige Registro</td>
                    <td><?= $rsRegistro['exige_registro']; ?></td>
                  </tr>
                </tbody>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/bsc/estado_civil/visualizar.js"></script>