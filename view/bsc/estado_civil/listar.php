...
$tituloImpressao          = "Relatório de estados civis cadastrados no sistema DELFOS";
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Estados Civis</a>
          </li>
        </ul>
      </div>
    </div>
            ...
            <div class="app-datatable-default overflow-auto">
              ...
              <!-- <table id="table_modelo_01" class="display app-data-table default-data-table"> -->
                <table id="table_listar" class="table table-striped display app-data-table">
                  ...
                  <tbody>
                    <?php
                    foreach ($rsEstadoCivis as $kObj => $vObj) {
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/bsc/estado_civil/listar.js"></script>