...
<main>
  <div class="container-fluid">
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Estado Civil</a>
          </li>
        </ul>
      </div>
    </div>
    ...
    <form class="app-form" id="form_estado_civil" name="form_estado_civil" method="post" urltosend="bsc/estado_civil/salvar_identificacao" action="">
      <?php 
      include_once ('view/bsc/estado_civil/content_identificacao.php'); 
      ?>
    </form>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/bsc/estado_civil/cadastrar.js"></script>