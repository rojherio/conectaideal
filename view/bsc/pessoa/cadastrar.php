        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <form class="app-form" id="form_pessoa" name="form_pessoa" method="post" action="">
              <!-- div row input - BEGIN -->
              <div class="row">
                <!-- createRadio($col, $label, $type, $name, $id, $class, $checked, $value, $required, $prop, $options) -->
                <?= createRadio("6", "6", "Tipo de Pessoa", "radio", "p_tipo", array("p_tipo_f", "p_tipo_j"), "radiomark outline-info ms-2", $rsPessoa['tipo'], array(1, 2), true, "", array("Física", "Jurídica")) ?>
                <!-- createInput($col, $label, $type, $name, $id, $class, $minlength, $maxlength, $placeholder, $title, $value, $required, $prop) -->
                <?= createInput("6", "CPF/CNPJ", "text", "p_cpf", "p_cpf", "form-control", "14", "18", "Digite o CPF ou CNPJ da pessoa", "", $rsUOTipo['cpf'], true, "") ;?>
              </div>
              <div class="row">
                <!-- createInput($col, $label, $type, $name, $id, $class, $minlength, $maxlength, $placeholder, $title, $value, $required, $prop) -->
              ...
              <div class="row">
                <!-- createRadio($col, $label, $type, $name, $id, $class, $checked,, $value, $required, $prop, $options) -->
                <?= createRadio("6", "6", "Sexo", "radio", "p_sexo", array("p_sexo_F", "p_sexo_M"), "radiomark outline-info ms-2", $rsPessoa['sexo'], array("Feminino", "Masculino"), true, "", array("Feminino", "Masculino")) ?>
              </div>
