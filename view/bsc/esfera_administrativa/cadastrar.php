...
<main>
  <div class="container-fluid">
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Esfera Administrativa</a>
          </li>
        </ul>
      </div>
    </div>
    ...
    <form class="app-form" id="form_esfera_administrativa" name="form_esfera_administrativa" method="post" urltosend="bsc/esfera_administrativa/salvar_identificacao" action="">
      <?php 
      include_once ('view/bsc/esfera_administrativa/content_identificacao.php'); 
      ?>
    </form>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/bsc/esfera_administrativa/cadastrar.js"></script>