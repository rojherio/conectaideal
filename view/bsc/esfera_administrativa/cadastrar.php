...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_esfera_administrativa" name="form_esfera_administrativa" method="post" action="">
      <input type="hidden" name="ea_id" id="ea_id" value="<?= $rsRegistro['id'] ;?>">
