...
if (empty($id)) {
  header('Location: '.PORTAL_URL.'view/bsc/esfera_administrativa/listar');
}
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/bsc/esfera_administrativa/visualizar.js"></script>