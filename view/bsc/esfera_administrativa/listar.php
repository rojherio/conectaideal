...
$tituloFormulario1        = "Tabela com listagem de Esfera Administrativa";
$descricaoFormulario1     = "Dados de identificação de esfera administrativa";
$tituloImpressao          = "Relatório de esfera administrativa cadastradas no sistema conectaideal";
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/bsc/esfera_administrativa/listar.js"></script>