...
if (empty($id)) {
  header('Location: '.PORTAL_URL.'view/bsc/banco/listar');
}
            ...
            <div class="app-datatable-default overflow-auto">
              ...
              <table id="table_visualizar" class="table table-striped display app-data-table">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>Codigo</td>
                    <td><?= $rsRegistro['codigo']; ?></td>
                  </tr>
                  <tr>
                    <td>Sigla</td>
                    <td><?= $rsRegistro['sigla']; ?></td>
                  </tr>
                  <tr>
                    <td>ISPB</td>
                    <td><?= $rsRegistro['ispb']; ?></td>
                  </tr>
                </tbody>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/bsc/banco/visualizar.js"></script>