...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_banco" name="form_banco" method="post" urltosend="bsc/banco/salvar_identificacao" action="">
      <?php 
      include_once ('view/bsc/banco/content_identificacao.php'); 
      ?>
    </form>
