...
$tituloImpressao          = "Relatório de situações de funcionamento cadastradas no sistema DELFOS";
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/bsc/funcionamento_situacao/listar.js"></script>