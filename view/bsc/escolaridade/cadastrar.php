...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_escolaridade" name="form_escolaridade" method="post" urltosend="bsc/escolaridade/salvar_identificacao" action="">
      <?php 
      include_once ('view/bsc/escolaridade/content_identificacao.php'); 
      ?>
    </form>
