...
$tituloPagina             = "Listagem de Zonas";
$descricaoPagina          = "Informações de zonas";
$tituloFormulario1        = "Tabela com listagem de Zonas";
$descricaoFormulario1     = "Dados de identificação de zonas";
$tituloImpressao          = "Relatório de zonas cadastradas no sistema conectaideal";
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Zonas</a>
          </li>
        </ul>
      </div>
    </div>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/bsc/zona/listar.js"></script>