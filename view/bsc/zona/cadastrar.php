...
<main>
  <div class="container-fluid">
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Zona</a>
          </li>
        </ul>
      </div>
    </div>
    ...
    <form class="app-form" id="form_zona" name="form_zona" method="post" urltosend="bsc/zona/salvar_identificacao" action="">
      <?php 
      include_once ('view/bsc/zona/content_identificacao.php'); 
      ?>
    </form>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/bsc/zona/cadastrar.js"></script>