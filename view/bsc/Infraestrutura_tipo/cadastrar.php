...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_infraestrutura_tipo" name="form_infraestrutura_tipo" method="post" action="">
      <input type="hidden" name="it_id" id="it_id" value="<?= $rsRegistro['id'] ;?>">
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/bsc/infraestrutura_tipo/cadastrar.js"></script>