...
$tituloImpressao          = "Relatório de tipos de infraestrutura cadastradas no sistema DELFOS";
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/bsc/infraestrutura_tipo/listar.js"></script>