...
$tituloPagina             = "Listagem de Categorias Administrativa";
$descricaoPagina          = "Informações de categorias administrativa";
$tituloFormulario1        = "Tabela com listagem de Categorias Administrativa";
$descricaoFormulario1     = "Dados de identificação de categorias administrativa";
$tituloImpressao          = "Relatório de categorias administrativa cadastradas no sistema conectaideal";
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Categorias Administrativa</a>
          </li>
        </ul>
      </div>
    </div>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/bsc/categoria_administrativa/listar.js"></script>