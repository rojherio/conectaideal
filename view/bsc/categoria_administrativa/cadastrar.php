...
<main>
  <div class="container-fluid">
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Categoria Administrativa</a>
          </li>
        </ul>
      </div>
    </div>
    ...
    <form class="app-form" id="form_categoria_administrativa" name="form_categoria_administrativa" method="post" action="">
      <input type="hidden" name="ca_id" id="ca_id" value="<?= $rsRegistro['id'] ;?>">
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/bsc/categoria_administrativa/cadastrar.js"></script>