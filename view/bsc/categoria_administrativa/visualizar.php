...
if (empty($id)) {
  header('Location: '.PORTAL_URL.'view/bsc/categoria_administrativa/listar');
}
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/bsc/categoria_administrativa/visualizar.js"></script>