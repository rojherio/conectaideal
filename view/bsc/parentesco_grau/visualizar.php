...
if (empty($id)) {
  header('Location: '.PORTAL_URL.'view/bsc/parentesco_grau/listar');
}
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/bsc/parentesco_grau/visualizar.js"></script>