...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_parentesco_grau" name="form_parentesco_grau" method="post" urltosend="bsc/parentesco_grau/salvar_identificacao" action="">
      <?php 
      include_once ('view/bsc/parentesco_grau/content_identificacao.php'); 
      ?>
    </form>
