...
$tituloPagina             = "Listagem de Graus de Parentesco";
$descricaoPagina          = "Informações de graus de parentesco";
$tituloFormulario1        = "Tabela com listagem de Graus de Parentesco";
$descricaoFormulario1     = "Dados de identificação de graus de parentesco";
$tituloImpressao          = "Relatório de graus de parentesco cadastrados no sistema DELFOS";
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Graus de Parentesco</a>
          </li>
        </ul>
      </div>
    </div>
            ...
            <div class="app-datatable-default overflow-auto">
              ...
              <!-- <table id="table_modelo_01" class="display app-data-table default-data-table"> -->
                <table id="table_listar" class="table table-striped display app-data-table">
                  ...
                  <tbody>
                    <?php
                    foreach ($rsParentescoGraus as $kObj => $vObj) {
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/bsc/parentesco_grau/listar.js"></script>