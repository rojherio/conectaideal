            ...
            <div class="card-body equal-card">
              <ul class="nav nav-tabs tab-primary bg-primary p-2" id="bg" role="tablist">
                ...
                if ($rsRegistroS['id']) {
                  ...
                  <li class="nav-item" role="presentation">
                    <button aria-controls="tab-pane-5" data-bs-target="#tab-pane-4" id="tab-5" aria-selected="false" class="nav-link <?= $tabPane == 5 ? 'active' : '' ;?>" data-bs-toggle="tab" role="tab" type="button">
                      <i class="ti ti-history pe-1 ps-1"></i>Formação Complementar
                    </button>
                  </li>
                  <li class="nav-item" role="presentation">
                    <button aria-controls="tab-pane-6" data-bs-target="#tab-pane-4" id="tab-6" aria-selected="false" class="nav-link <?= $tabPane == 6 ? 'active' : '' ;?>" data-bs-toggle="tab" role="tab" type="button">
                      <i class="ti ti-history pe-1 ps-1"></i>Formação Continuada
                    </button>
                  </li>
                  <li class="nav-item" role="presentation">
                    <button aria-controls="tab-pane-7" data-bs-target="#tab-pane-5" id="tab-7" aria-selected="false" class="nav-link <?= $tabPane == 7 ? 'active' : '' ;?>" data-bs-toggle="tab" role="tab" type="button">
                      <i class="ti ti-history pe-1 ps-1"></i>Familiar
                    </button>
                  </li>
                  <li class="nav-item" role="presentation">
                    <button aria-controls="tab-pane-8" data-bs-target="#tab-pane-6" id="tab-8" aria-selected="false" class="nav-link <?= $tabPane == 8 ? 'active' : '' ;?>" data-bs-toggle="tab" role="tab" type="button">
                      <i class="ti ti-history pe-1 ps-1"></i>Dependentes
                    </button>
                  </li>
                  <li class="nav-item" role="presentation">
                    <button aria-controls="tab-pane-9" data-bs-target="#tab-pane-7" id="tab-9" aria-selected="false" class="nav-link <?= $tabPane == 9 ? 'active' : '' ;?>" data-bs-toggle="tab" role="tab" type="button">
                      <i class="ti ti-history pe-1 ps-1"></i>Bancário
                    </button>
                  </li>
                  <li class="nav-item" role="presentation">
                    <button aria-controls="tab-pane-10" data-bs-target="#tab-pane-8" id="tab-10" aria-selected="false" class="nav-link <?= $tabPane == 10 ? 'active' : '' ;?>" data-bs-toggle="tab" role="tab" type="button">
                      <i class="ti ti-history pe-1 ps-1"></i>Contratos
                    </button>
                  </li>
                  <li class="nav-item" role="presentation">
                    <button aria-controls="tab-pane-11" data-bs-target="#tab-pane-9" id="tab-11" aria-selected="false" class="nav-link <?= $tabPane == 11 ? 'active' : '' ;?>" data-bs-toggle="tab" role="tab" type="button">
                      <i class="ti ti-history pe-1 ps-1"></i>Outros Vínculos
                    </button>
                  </li>
                  <li class="nav-item" role="presentation">
                    <button aria-controls="tab-pane-12" data-bs-target="#tab-pane-10" id="tab-12" aria-selected="false" class="nav-link <?= $tabPane == 12 ? 'active' : '' ;?>" data-bs-toggle="tab" role="tab" type="button">
                      <i class="ti ti-history pe-1 ps-1"></i>OBS/Ocorrências
                    </button>
                  </li>
                  <li class="nav-item" role="presentation">
                    <button aria-controls="tab-pane-13" data-bs-target="#tab-pane-11" id="tab-13" aria-selected="false" class="nav-link <?= $tabPane == 13 ? 'active' : '' ;?>" data-bs-toggle="tab" role="tab" type="button">
