          ...
          <div class="">
            <div class="card-body equal-card">
              ...
              <div class="tab-content" id="v-bgContent">
                ...
                <div aria-labelledby="tab-pane-5" id="tab-pane-5" class="tab-pane fade <?= $tabPane == 5 ? 'show active' : '' ;?>" role="tabpanel" tabindex="5">
                ...
                <div aria-labelledby="tab-pane-6" id="tab-pane-6" class="tab-pane fade <?= $tabPane == 6 ? 'show active' : '' ;?>" role="tabpanel" tabindex="6">
                ...
                <div aria-labelledby="tab-pane-7" id="tab-pane-7" class="tab-pane fade <?= $tabPane == 7 ? 'show active' : '' ;?>" role="tabpanel" tabindex="7">
                ...
                <div aria-labelledby="tab-pane-8" id="tab-pane-8" class="tab-pane fade <?= $tabPane == 8 ? 'show active' : '' ;?>" role="tabpanel" tabindex="8">
                ...
                <div aria-labelledby="tab-pane-9" id="tab-pane-9" class="tab-pane fade <?= $tabPane == 9 ? 'show active' : '' ;?>" role="tabpanel" tabindex="9">
                ...
                <div aria-labelledby="tab-pane-10" id="tab-pane-10" class="tab-pane fade <?= $tabPane == 10 ? 'show active' : '' ;?>" role="tabpanel" tabindex="10">
                ...
                <div aria-labelledby="tab-pane-11" id="tab-pane-11" class="tab-pane fade <?= $tabPane == 11 ? 'show active' : '' ;?>" role="tabpanel" tabindex="end">
