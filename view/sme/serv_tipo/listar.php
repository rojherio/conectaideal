...
$tituloImpressao          = "Relatório de tipos de servidor cadastradas no sistema conectaideal";
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/sme/serv_tipo/listar.js"></script>