...
$tituloPagina             = "Listagem de Funções Desempenhada por Funcionarios";
$descricaoPagina          = "Informações de funções desempenhada por funcionarios";
$tituloFormulario1        = "Tabela com listagem de Funções Desempenhada por Funcionarios";
$descricaoFormulario1     = "Dados de identificação de funções desempenhada por funcionarios";
$tituloImpressao          = "Relatório de funções desempenhada por funcionarios cadastradas no sistema conectaideal";
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Funções Desempenhada por Funcionarios</a>
          </li>
        </ul>
      </div>
    </div>
                  ...
                  <tbody>
                    ...
                    foreach ($rsRegistros as $kObj => $vObj) {
                      ...
                      <tr>
                        ...
                        <td id="td_funcao_tipo"><?= $vObj['funcao_tipo_nome']; ?></td>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/funcao/listar.js"></script>