...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_funcao" name="form_funcao" method="post" action="">
      <input type="hidden" name="f_id" id="f_id" value="<?= $rsRegistro['id'] ;?>">
            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <?= createSelect(array(
                  ...
                  /*string*/    'value'       => $rsRegistro['ue_funcao_tipo_id'],
