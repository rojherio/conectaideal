...
$tituloPagina             = "Listagem de Situações de Regulamentação/Autorização da Escola";
$descricaoPagina          = "Informações de situações de regulamentação/autorização da escola";
$tituloFormulario1        = "Tabela com listagem de Situações de Regulamentação/Autorização da Escola";
$descricaoFormulario1     = "Dados de identificação de situações de regulamentação/autorização da escola";
$tituloImpressao          = "Relatório de situações de regulamentação/autorização da escola cadastradas no sistema conectaideal";
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Situações de Regulamentação/Autorização da Escola</a>
          </li>
        </ul>
      </div>
    </div>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/regulam_situacao/listar.js"></script>