...
$tituloPagina             = "Listagem de Tipos de Vínculo a Outra Unidade Escolar";
$descricaoPagina          = "Informações de tipos de vínculo a outra unidade escolar";
$tituloFormulario1        = "Tabela com listagem de Tipos de Vínculo a Outra Unidade Escolar";
$descricaoFormulario1     = "Dados de identificação de tipos de vínculo a outra unidade escolar";
$tituloImpressao          = "Relatório de tipos de vínculo a outra unidade escolar cadastradas no sistema conectaideal";
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Tipos de Vínculo a Outra Unidade Escolar</a>
          </li>
        </ul>
      </div>
    </div>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/ue_vinculada_tipo/listar.js"></script>