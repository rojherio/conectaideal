...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_ue_vinculada_tipo" name="form_ue_vinculada_tipo" method="post" action="">
      <input type="hidden" name="uvt_id" id="uvt_id" value="<?= $rsRegistro['id'] ;?>">
