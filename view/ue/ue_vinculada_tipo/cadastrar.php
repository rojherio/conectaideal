...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_ue_vinculada_tipo" name="form_ue_vinculada_tipo" method="post" urltosend="ue/ue_vinculada_tipo/salvar_identificacao" action="">
      <?php 
      include_once ('view/ue/ue_vinculada_tipo/content_identificacao.php'); 
      ?>
    </form>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/ue_vinculada_tipo/cadastrar.js"></script>