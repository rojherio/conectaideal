...
if (empty($id)) {
  header('Location: '.PORTAL_URL.'view/ue/categoria_escola_privada/listar');
}
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/categoria_escola_privada/visualizar.js"></script>