...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_categoria_escola_privada" name="form_categoria_escola_privada" method="post" urltosend="ue/categoria_escola_privada/salvar_identificacao" action="">
      <?php 
      include_once ('view/ue/categoria_escola_privada/content_identificacao.php'); 
      ?>
    </form>
