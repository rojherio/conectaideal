...
$tituloPagina             = "Listagem de Tipos de Função Desempenhada por Funcionarios";
$descricaoPagina          = "Informações de tipos de função desempenhada por funcionarios";
$tituloFormulario1        = "Tabela com listagem de Tipos de Função Desempenhada por Funcionarios";
$descricaoFormulario1     = "Dados de identificação de tipos de função desempenhada por funcionarios";
$tituloImpressao          = "Relatório de tipos de função desempenhada por funcionarios cadastradas no sistema conectaideal";
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Tipos de Função Desempenhada por Funcionarios</a>
          </li>
        </ul>
      </div>
    </div>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/funcao_tipo/listar.js"></script>