...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_funcao_tipo" name="form_funcao_tipo" method="post" urltosend="ue/funcao_tipo/salvar_identificacao" action="">
      <?php 
      include_once ('view/ue/funcao_tipo/content_identificacao.php'); 
      ?>
    </form>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/funcao_tipo/cadastrar.js"></script>