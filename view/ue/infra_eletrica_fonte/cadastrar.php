...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_infra_eletrica_fonte" name="form_infra_eletrica_fonte" method="post" action="">
      <input type="hidden" name="ief_id" id="ief_id" value="<?= $rsRegistro['id'] ;?>">
