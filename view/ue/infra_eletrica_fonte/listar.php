...
$tituloPagina             = "Listagem de Fontes de Energia Elétrica";
$descricaoPagina          = "Informações de fontes de energia elétrica";
$tituloFormulario1        = "Tabela com listagem de Fontes de Energia Elétrica";
$descricaoFormulario1     = "Dados de identificação de fontes de energia elétrica";
$tituloImpressao          = "Relatório de fontes de energia elétrica cadastradas no sistema conectaideal";
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Fontes de Energia Elétrica</a>
          </li>
        </ul>
      </div>
    </div>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/infra_eletrica_fonte/listar.js"></script>