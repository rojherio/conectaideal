...
if (empty($id)) {
  header('Location: '.PORTAL_URL.'view/ue/infra_eletrica_fonte/listar');
}
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/infra_eletrica_fonte/visualizar.js"></script>