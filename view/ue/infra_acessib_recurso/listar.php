...
$tituloPagina             = "Listagem de Recursos de Acessibilidade";
$descricaoPagina          = "Informações de recursos de acessibilidade";
$tituloFormulario1        = "Tabela com listagem de Recursos de Acessibilidade";
$descricaoFormulario1     = "Dados de identificação de recursos de acessibilidade";
$tituloImpressao          = "Relatório de recursos de acessibilidade cadastradas no sistema conectaideal";
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Recursos de Acessibilidade</a>
          </li>
        </ul>
      </div>
    </div>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/infra_acessib_recurso/listar.js"></script>