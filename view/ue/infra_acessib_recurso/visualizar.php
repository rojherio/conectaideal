...
if (empty($id)) {
  header('Location: '.PORTAL_URL.'view/ue/infra_acessib_recurso/listar');
}
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/infra_acessib_recurso/visualizar.js"></script>