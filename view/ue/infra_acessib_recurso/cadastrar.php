...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_infra_acessib_recurso" name="form_infra_acessib_recurso" method="post" action="">
      <input type="hidden" name="iar_id" id="iar_id" value="<?= $rsRegistro['id'] ;?>">
