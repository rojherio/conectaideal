...
if (empty($id)) {
  header('Location: '.PORTAL_URL.'view/ue/nivel_ensino/listar');
}
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/ensino_modalidade_etapa/visualizar.js"></script>