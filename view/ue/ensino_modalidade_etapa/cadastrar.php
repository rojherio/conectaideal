...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_ensino_modalidade_etapa" name="form_ensino_modalidade_etapa" method="post" urltosend="ue/ensino_modalidade_etapa/salvar_identificacao" action="">
      <?php 
      include_once ('view/ue/ensino_modalidade_etapa/content_identificacao.php'); 
      ?>
    </form>
