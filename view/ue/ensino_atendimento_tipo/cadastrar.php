...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_ensino_atendimento_tipo" name="form_ensino_atendimento_tipo" method="post" urltosend="ue/ensino_atendimento_tipo/salvar_identificacao" action="">
      <?php 
      include_once ('view/ue/ensino_atendimento_tipo/content_identificacao.php'); 
      ?>
    </form>
