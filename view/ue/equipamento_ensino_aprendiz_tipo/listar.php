...
$tituloPagina             = "Listagem de Equipamentos para Ensino e Aprendizagem";
$descricaoPagina          = "Informações de equipamentos para ensino e aprendizagem";
$tituloFormulario1        = "Tabela com listagem de Equipamentos para Ensino e Aprendizagem";
$descricaoFormulario1     = "Dados de identificação de equipamentos para ensino e aprendizagem";
$tituloImpressao          = "Relatório de equipamentos para ensino e aprendizagem cadastradas no sistema conectaideal";
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Equipamentos para Ensino e Aprendizagem</a>
          </li>
        </ul>
      </div>
    </div>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/equipamento_ensino_aprendiz_tipo/listar.js"></script>