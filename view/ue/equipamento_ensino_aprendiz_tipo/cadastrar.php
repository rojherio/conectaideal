...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_equipamento_ensino_aprendiz_tipo" name="form_equipamento_ensino_aprendiz_tipo" method="post" action="">
      <input type="hidden" name="eeat_id" id="eeat_id" value="<?= $rsRegistro['id'] ;?>">
