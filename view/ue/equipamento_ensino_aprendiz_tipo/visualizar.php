...
if (empty($id)) {
  header('Location: '.PORTAL_URL.'view/ue/equipamento_ensino_aprendiz_tipo/listar');
}
...
$tituloPagina             = "Listagem do Equipamento para Ensino e Aprendizagem";
$descricaoPagina          = "Informações do equipamento para ensino e aprendizagem";
$tituloFormulario1        = "Tabela informações do Equipamento para Ensino e Aprendizagem";
$descricaoFormulario1     = "Dados de informações do equipamento para ensino e aprendizagem cadastrada no sistema conectaideal";
$tituloImpressao          = "Relatório de informações do equipamento para ensino e aprendizagem cadastrada no sistema conectaideal";
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/equipamento_ensino_aprendiz_tipo/visualizar.js"></script>