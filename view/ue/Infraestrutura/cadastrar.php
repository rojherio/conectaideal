...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_infraestrutura" name="form_infraestrutura" method="post" urltosend="ue/infraestrutura/salvar_identificacao" action="">
      <?php 
      include_once ('view/ue/infraestrutura/content_identificacao.php'); 
      ?>
    </form>
