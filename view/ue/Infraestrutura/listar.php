...
$tituloPagina             = "Listagem de Infraestruturas";
$descricaoPagina          = "Informações de infraestruturas";
$tituloFormulario1        = "Tabela com listagem de Infraestruturas";
$descricaoFormulario1     = "Dados de identificação de infraestruturas";
$tituloImpressao          = "Relatório de infraestruturas cadastradas no sistema conectaideal";
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Infraestruturas</a>
          </li>
        </ul>
      </div>
    </div>
                  ...
                  <tbody>
                    ...
                    foreach ($rsRegistros as $kObj => $vObj) {
                      ...
                      <tr>
                        ...
                        <td id="td_infraestrutura_tipo"><?= $vObj['infraestrutura_tipo_nome']; ?></td>
