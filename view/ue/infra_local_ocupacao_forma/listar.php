...
$tituloPagina             = "Listagem de Formas de Ocupação do Prédio Escolar";
$descricaoPagina          = "Informações de Formas de Ocupação do Prédio Escolar";
$tituloFormulario1        = "Tabela com listagem de Formas de Ocupação do Prédio Escolar";
$descricaoFormulario1     = "Dados de identificação de Formas de Ocupação do Prédio Escolar";
$tituloImpressao          = "Relatório de Formas de Ocupação do Prédio Escolar cadastradas no sistema conectaideal";
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Formas de Ocupação do Prédio Escolar</a>
          </li>
        </ul>
      </div>
    </div>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/infra_local_ocupacao_forma/listar.js"></script>