...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_infra_local_ocupacao_forma" name="form_infra_local_ocupacao_forma" method="post" urltosend="ue/infra_local_ocupacao_forma/salvar_identificacao" action="">
      <?php 
      include_once ('view/ue/infra_local_ocupacao_forma/content_identificacao.php'); 
      ?>
    </form>
