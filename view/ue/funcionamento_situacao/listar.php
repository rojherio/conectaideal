...
$tituloPagina             = "Listagem de Situações de Funcionamento";
$descricaoPagina          = "Informações de situações de funcionamento";
$tituloFormulario1        = "Tabela com listagem de Situações de Funcionamento";
$descricaoFormulario1     = "Dados de identificação de situações de funcionamento";
$tituloImpressao          = "Relatório de situações de funcionamento cadastradas no sistema conectaideal";
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Situações de Funcionamento</a>
          </li>
        </ul>
      </div>
    </div>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/funcionamento_situacao/listar.js"></script>