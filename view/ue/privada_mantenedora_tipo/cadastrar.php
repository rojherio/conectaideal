...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_privada_mantenedora_tipo" name="form_privada_mantenedora_tipo" method="post" urltosend="ue/privada_mantenedora_tipo/salvar_identificacao" action="">
      <?php 
      include_once ('view/ue/privada_mantenedora_tipo/content_identificacao.php'); 
      ?>
    </form>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/privada_mantenedora_tipo/cadastrar.js"></script>