...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_privada_mantenedora_tipo" name="form_privada_mantenedora_tipo" method="post" action="">
      <input type="hidden" name="pmt_id" id="pmt_id" value="<?= $rsRegistro['id'] ;?>">
