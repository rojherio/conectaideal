...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_ensino_modalidade_tipo" name="form_ensino_modalidade_tipo" method="post" urltosend="ue/ensino_modalidade_tipo/salvar_identificacao" action="">
      <?php 
      include_once ('view/ue/ensino_modalidade_tipo/content_identificacao.php'); 
      ?>
    </form>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/ensino_modalidade_tipo/cadastrar.js"></script>