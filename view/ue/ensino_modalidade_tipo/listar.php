...
$tituloPagina             = "Listagem de Modalidades de Ensino";
$descricaoPagina          = "Informações de modalidades de ensino";
$tituloFormulario1        = "Tabela com listagem de Modalidades de Ensino";
$descricaoFormulario1     = "Dados de identificação de modalidades de ensino";
$tituloImpressao          = "Relatório de modalidades de ensino cadastradas no sistema conectaideal";
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Modalidades de Ensino</a>
          </li>
        </ul>
      </div>
    </div>
