...
$tituloPagina             = "Listagem de Tipos de Equipamento/Computador para o Aluno";
$descricaoPagina          = "Informações de tipos de equipamento/computador para o aluno";
$tituloFormulario1        = "Tabela com listagem de Tipos de Equipamento/Computador para o Aluno";
$descricaoFormulario1     = "Dados de identificação de tipos de equipamento/computador para o aluno";
$tituloImpressao          = "Relatório de tipos de equipamento/computador para o aluno cadastradas no sistema conectaideal";
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Tipos de Equipamento/Computador para o Aluno</a>
          </li>
        </ul>
      </div>
    </div>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/equipamento_computador_tipo/listar.js"></script>