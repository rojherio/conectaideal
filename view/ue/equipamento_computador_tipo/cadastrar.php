...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_equipamento_computador_tipo" name="form_equipamento_computador_tipo" method="post" action="">
      <input type="hidden" name="ect_id" id="ect_id" value="<?= $rsRegistro['id'] ;?>">
