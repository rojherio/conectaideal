...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_equipamento_computador_tipo" name="form_equipamento_computador_tipo" method="post" urltosend="ue/equipamento_computador_tipo/salvar_identificacao" action="">
      <?php 
      include_once ('view/ue/equipamento_computador_tipo/content_identificacao.php'); 
      ?>
    </form>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/equipamento_computador_tipo/cadastrar.js"></script>