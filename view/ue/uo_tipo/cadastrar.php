...
$tituloPagina             = "Cadastro do Tipo de Unidade Organizacional";
...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_uo_tipo" name="form_uo_tipo" method="post" urltosend="ue/uo_tipo/salvar_identificacao" action="">
      <?php 
      include_once ('view/ue/uo_tipo/content_identificacao.php'); 
      ?>
    </form>
