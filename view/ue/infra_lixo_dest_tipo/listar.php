...
$tituloPagina             = "Listagem de Tipos de Destinação do Lixo";
$descricaoPagina          = "Informações de tipos de destinação do lixo";
$tituloFormulario1        = "Tabela com listagem de Tipos de Destinação do Lixo";
$descricaoFormulario1     = "Dados de identificação de tipos de destinação do lixo";
$tituloImpressao          = "Relatório de tipos de destinação do lixo cadastradas no sistema conectaideal";
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Tipos de Destinação do Lixo</a>
          </li>
        </ul>
      </div>
    </div>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/infra_lixo_dest_tipo/listar.js"></script>