...
$descricaoFormulario1     = "Dados de informações do tipo de destinação do lixo cadastrada no sistema DELFOS";
$tituloImpressao          = "Relatório de informações do tipo de destinação do lixo cadastrada no sistema DELFOS";
