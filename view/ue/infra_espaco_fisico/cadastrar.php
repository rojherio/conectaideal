...
<main>
  <div class="container-fluid">
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Dependência/Espaço Físico</a>
          </li>
        </ul>
      </div>
    </div>
    ...
    <form class="app-form" id="form_infra_espaco_fisico" name="form_infra_espaco_fisico" method="post" urltosend="ue/infra_espaco_fisico/salvar_identificacao" action="">
      <?php 
      include_once ('view/ue/infra_espaco_fisico/content_identificacao.php'); 
      ?>
    </form>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/infra_espaco_fisico/cadastrar.js"></script>