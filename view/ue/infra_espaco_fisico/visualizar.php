...
if (empty($id)) {
  header('Location: '.PORTAL_URL.'view/ue/infra_espaco_fisico/listar');
}
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/infra_espaco_fisico/visualizar.js"></script>