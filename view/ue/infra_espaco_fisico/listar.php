...
$tituloPagina             = "Listagem de Dependências/Espaços Físicos";
$descricaoPagina          = "Informações de dependências/espaços físicos";
$tituloFormulario1        = "Tabela com listagem de Dependências/Espaços Físicos";
$descricaoFormulario1     = "Dados de identificação de dependências/espaços físicos";
$tituloImpressao          = "Relatório de dependências/espaços físicos cadastradas no sistema conectaideal";
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Dependências/Espaços Físicos</a>
          </li>
        </ul>
      </div>
    </div>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/infra_espaco_fisico/listar.js"></script>