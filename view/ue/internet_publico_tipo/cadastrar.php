...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_internet_publico_tipo" name="form_internet_publico_tipo" method="post" urltosend="ue/internet_publico_tipo/salvar_identificacao" action="">
      <?php 
      include_once ('view/ue/internet_publico_tipo/content_identificacao.php'); 
      ?>
    </form>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/internet_publico_tipo/cadastrar.js"></script>