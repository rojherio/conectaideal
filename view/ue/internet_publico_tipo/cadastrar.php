...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_internet_publico_tipo" name="form_internet_publico_tipo" method="post" action="">
      <input type="hidden" name="ipt_id" id="ipt_id" value="<?= $rsRegistro['id'] ;?>">
