...
if (empty($id)) {
  header('Location: '.PORTAL_URL.'view/ue/internet_publico_tipo/listar');
}
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/internet_publico_tipo/visualizar.js"></script>