    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="row">
          <?= createInput(array(
            /*int 1-12*/  'col'         => 12,
            /*string*/    'label'       => 'Nome do Público a Usufruir da Internet da Unidade Educativa',
            /*string*/    'type'        => 'text',
            ...
            /*int*/       'minlength'   => 3,
            /*int*/       'maxlength'   => 100,
            /*string*/    'placeholder' => 'Digite o nome do público a usufruir da internet da unidade educativa',
        ...
        <div class="row">
          <?= createTextArea(array(
            ...
            /*int*/       'minlength'   => 3,
            /*int*/       'maxlength'   => '',
            /*string*/    'placeholder' => 'Digite a descrição do público a usufruir da internet da unidade educativa',
