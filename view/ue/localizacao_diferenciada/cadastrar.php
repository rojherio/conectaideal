...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_localizacao_diferenciada" name="form_localizacao_diferenciada" method="post" urltosend="ue/localizacao_diferenciada/salvar_identificacao" action="">
      <?php 
      include_once ('view/ue/localizacao_diferenciada/content_identificacao.php'); 
      ?>
    </form>
