...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_turno" name="form_turno" method="post" urltosend="ue/turno/salvar_identificacao" action="">
      <?php 
      include_once ('view/ue/turno/content_identificacao.php'); 
      ?>
    </form>
