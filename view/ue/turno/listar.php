...
$tituloPagina             = "Listagem de Horário de Turnos";
$descricaoPagina          = "Informações de turnos";
$tituloFormulario1        = "Tabela com listagem de Horário de Turnos";
$descricaoFormulario1     = "Dados de identificação de turnos";
$tituloImpressao          = "Relatório de turnos cadastradas no sistema conectaideal";
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Turnos</a>
          </li>
        </ul>
      </div>
    </div>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/turno/listar.js"></script>