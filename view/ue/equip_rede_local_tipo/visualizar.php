...
if (empty($id)) {
  header('Location: '.PORTAL_URL.'view/ue/equip_rede_local_tipo/listar');
}
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/equip_rede_local_tipo/visualizar.js"></script>