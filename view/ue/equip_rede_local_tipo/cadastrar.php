...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_equip_rede_local_tipo" name="equip_rede_local_tipo" method="post" urltosend="ue/equip_rede_local_tipo/salvar_identificacao" action="">
      <?php 
      include_once ('view/ue/equip_rede_local_tipo/content_identificacao.php'); 
      ?>
    </form>
