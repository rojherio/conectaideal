...
$tituloPagina             = "Listagem de Tipos de Rede Local de Interligação de computadores";
$descricaoPagina          = "Informações de tipos de rede local de interligação de computadores";
$tituloFormulario1        = "Tabela com listagem de Tipos de Rede Local de Interligação de computadores";
$descricaoFormulario1     = "Dados de identificação de tipos de rede local de interligação de computadores";
$tituloImpressao          = "Relatório de tipos de rede local de interligação de computadores cadastradas no sistema conectaideal";
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Tipos de Rede Local de Interligação de computadores</a>
          </li>
        </ul>
      </div>
    </div>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/equip_rede_local_tipo/listar.js"></script>