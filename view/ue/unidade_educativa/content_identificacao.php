...
$stmt->bindValue(1, $id);
$stmt->execute();
$rsRegistroInfraLocalFuncionamIds = array_column($stmt->fetchAll(PDO::FETCH_ASSOC), 'td_ref_id');
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        foreach ($rsRegistroAnoLetivos as $key => $obj) {
          ...
          <div class="row border border-primary rounded pt-3 me-1 ms-1 mt-0 mb-3">
