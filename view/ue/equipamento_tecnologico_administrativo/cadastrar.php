...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_equip_tecn_administrativo" name="form_equip_tecn_administrativo" method="post" action="">
      <input type="hidden" name="eta_id" id="eta_id" value="<?= $rsRegistro['id'] ;?>">
