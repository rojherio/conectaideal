...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_equipamento_tecnologico_administrativo" name="form_equipamento_tecnologico_administrativo" method="post" urltosend="ue/equipamento_tecnologico_administrativo/salvar_identificacao" action="">
      <?php 
      include_once ('view/ue/equipamento_tecnologico_administrativo/content_identificacao.php'); 
      ?>
    </form>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/equipamento_tecnologico_administrativo/cadastrar.js"></script>