...
if (empty($id)) {
  header('Location: '.PORTAL_URL.'view/ue/infra_local_funcionam/listar');
}
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/infra_local_funcionam/visualizar.js"></script>