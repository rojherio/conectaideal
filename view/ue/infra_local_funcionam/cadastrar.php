...
$stmt = $db->prepare("SELECT 
  ...
  ilf.nome,
  ilf.descricao
  FROM ue_infra_local_funcionam AS ilf
  WHERE ilf.id = ? ;");
$stmt->bindValue(1, $id);
$stmt->execute();
...
$tituloPagina             = "Cadastro de Local de Funcionamento da Escola";
$descricaoPagina          = "Informações do local de funcionamento da escola";
$tituloFormulario1        = "Dados do Local de Funcionamento da Escola";
...
$descricaoFormulario5     = "Defina se esse cadastro de local de funcionamento da escola está ativo ou inativo";
...
<main>
  <div class="container-fluid">
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Local de Funcionamento da Escola</a>
          </li>
        </ul>
      </div>
    </div>
    ...
    <form class="app-form" id="form_infra_local_funcionam" name="form_infra_local_funcionam" method="post" action="">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row">
                <?= createInput(array(
                  /*int 1-12*/  'col'         => 12,
                  /*string*/    'label'       => 'Nome do Local de Funcionamento da Escola',
                  /*string*/    'type'        => 'text',
                  /*string*/    'name'        => 'ilf_nome',
                  /*string*/    'id'          => 'ilf_nome',
            ...
            <div class="card-body">
              ...
              <div class="row">
                <?= createCheckbox(array(
                  ...
                  /*string*/    'name'        => 'ilf_status',
                  /*string*/    'id'          => 'ilf_status',
                  /*string*/    'class'       => 'toggle',
                  /*string*/    'value'       => 1,
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/infra_local_funcionam/cadastrar.js"></script>