...
$tituloPagina             = "Listagem de Locais de Funcionamento da Escola";
$descricaoPagina          = "Informações de locais de funcionamento da escola";
$tituloFormulario1        = "Tabela com listagem de Locais de Funcionamento da Escola";
$descricaoFormulario1     = "Dados de identificação de locais de funcionamento da escola";
$tituloImpressao          = "Relatório de locais de funcionamento da escola cadastradas no sistema conectaideal";
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Locais de Funcionamento da Escola</a>
          </li>
        </ul>
      </div>
    </div>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/infra_local_funcionam/listar.js"></script>