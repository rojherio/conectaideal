...
$tituloPagina             = "Listagem de Tipos de Esgotamento Sanitário";
$descricaoPagina          = "Informações de tipos de esgotamento sanitário";
$tituloFormulario1        = "Tabela com listagem de Tipos de Esgotamento Sanitário";
$descricaoFormulario1     = "Dados de identificação de tipos de esgotamento sanitário";
$tituloImpressao          = "Relatório de tipos de esgotamento sanitário cadastradas no sistema conectaideal";
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Tipos de Esgotamento Sanitário</a>
          </li>
        </ul>
      </div>
    </div>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/infra_esgot_tipo/listar.js"></script>