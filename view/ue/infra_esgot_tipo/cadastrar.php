...
$stmt = $db->prepare("SELECT 
  ...
  iet.nome,
  iet.descricao
  FROM ue_infra_esgot_tipo AS iet
  WHERE iet.id = ? ;");
$stmt->bindValue(1, $id);
$stmt->execute();
...
$tituloPagina             = "Cadastro de Tipo de Esgotamento Sanitário";
$descricaoPagina          = "Informações do tipo de esgotamento sanitário";
$tituloFormulario1        = "Dados do Tipo de Esgotamento Sanitário";
$descricaoFormulario1     = "Dados da identificação do tipo de esgotamento sanitário";
$tituloFormulario2        = "";
...
$descricaoFormulario5     = "Defina se esse cadastro de tipo de esgotamento sanitário está ativo ou inativo";
...
<main>
  <div class="container-fluid">
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Tipo de Esgotamento Sanitário</a>
          </li>
        </ul>
      </div>
    </div>
    ...
    <form class="app-form" id="form_infra_esgot_tipo" name="form_infra_esgot_tipo" method="post" action="">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row">
                <?= createInput(array(
                  /*int 1-12*/  'col'         => 12,
                  /*string*/    'label'       => 'Nome do Tipo de Esgotamento Sanitário',
                  /*string*/    'type'        => 'text',
                  /*string*/    'name'        => 'iet_nome',
                  /*string*/    'id'          => 'iet_nome',
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/infra_esgot_tipo/cadastrar.js"></script>