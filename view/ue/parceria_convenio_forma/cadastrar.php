...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_parceria_convenio_forma" name="form_parceria_convenio_forma" method="post" urltosend="ue/parceria_convenio_forma/salvar_identificacao" action="">
      <?php 
      include_once ('view/ue/parceria_convenio_forma/content_identificacao.php'); 
      ?>
    </form>
