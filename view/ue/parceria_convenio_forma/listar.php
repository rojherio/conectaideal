...
$tituloImpressao          = "Relatório de forma de contratação de parceria ou convênio cadastradas no sistema conectaideal";
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/parceria_convenio_forma/listar.js"></script>