...
$tituloPagina             = "Listagem de Tipos de Profissional de Ensino";
$descricaoPagina          = "Informações de tipos de profissional de ensino";
$tituloFormulario1        = "Tabela com listagem de Tipos de Profissional de Ensino";
$descricaoFormulario1     = "Dados de identificação de tipos de profissional de ensino";
$tituloImpressao          = "Relatório de tipos de profissional de ensino cadastradas no sistema DELFOS";
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Tipos de Profissional de Ensino</a>
          </li>
        </ul>
      </div>
    </div>
