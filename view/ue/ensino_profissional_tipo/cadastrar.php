...
<main>
  <div class="container-fluid">
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Tipo de Ensino Profissional</a>
          </li>
        </ul>
      </div>
    </div>
    ...
    <form class="app-form" id="form_ensino_profissional_tipo" name="form_ensino_profissional_tipo" method="post" urltosend="ue/ensino_profissional_tipo/salvar_identificacao" action="">
      <?php 
      include_once ('view/ue/ensino_profissional_tipo/content_identificacao.php'); 
      ?>
    </form>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/ensino_profissional_tipo/cadastrar.js"></script>