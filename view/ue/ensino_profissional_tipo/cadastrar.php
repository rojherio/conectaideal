...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_ensino_profissional_tipo" name="form_ensino_profissional_tipo" method="post" action="">
      <input type="hidden" name="ept_id" id="ept_id" value="<?= $rsRegistro['id'] ;?>">
