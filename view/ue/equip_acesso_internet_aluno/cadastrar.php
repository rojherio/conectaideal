...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_equip_acesso_internet_aluno" name="form_equip_acesso_internet_aluno" method="post" action="">
      <input type="hidden" name="eaia_id" id="eaia_id" value="<?= $rsRegistro['id'] ;?>">
