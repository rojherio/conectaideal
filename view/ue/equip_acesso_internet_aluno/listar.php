...
$tituloPagina             = "Listagem de Equipamentos para Acessar a Internet";
$descricaoPagina          = "Informações de equipamentos para acessar a internet";
$tituloFormulario1        = "Tabela com listagem de Equipamentos para Acessar a Internet";
$descricaoFormulario1     = "Dados de identificação de equipamentos para acessar a internet";
$tituloImpressao          = "Relatório de equipamentos para acessar a internet cadastradas no sistema conectaideal";
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Equipamentos para Acessar a Internet</a>
          </li>
        </ul>
      </div>
    </div>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/equip_acesso_internet_aluno/listar.js"></script>