...
$tituloPagina             = "Listagem de Tipos de tratamento do Lixo/Resíduos";
$descricaoPagina          = "Informações de tipos de tratamento do lixo/resíduos";
$tituloFormulario1        = "Tabela com listagem de Tipos de tratamento do Lixo/Resíduos";
$descricaoFormulario1     = "Dados de identificação de tipos de tratamento do lixo/resíduos";
$tituloImpressao          = "Relatório de tipos de tratamento do lixo/resíduos cadastradas no sistema conectaideal";
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Tipos de tratamento do Lixo/Resíduos</a>
          </li>
        </ul>
      </div>
    </div>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/infra_lixo_resid_trat_tipo/listar.js"></script>