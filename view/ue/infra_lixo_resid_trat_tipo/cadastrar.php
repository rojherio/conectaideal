...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_infra_lixo_resid_trat_tipo" name="form_infra_lixo_resid_trat_tipo" method="post" urltosend="ue/infra_lixo_resid_trat_tipo/salvar_identificacao" action="">
      <?php 
      include_once ('view/ue/infra_lixo_resid_trat_tipo/content_identificacao.php'); 
      ?>
    </form>
