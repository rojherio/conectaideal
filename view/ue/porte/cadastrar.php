...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_porte" name="form_porte" method="post" urltosend="ue/porte/salvar_identificacao" action="">
      <?php 
      include_once ('view/ue/porte/content_identificacao.php'); 
      ?>
    </form>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/porte/cadastrar.js"></script>