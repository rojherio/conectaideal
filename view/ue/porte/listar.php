...
$tituloPagina             = "Listagem de Portes de Alunos";
$descricaoPagina          = "Informações de portes de alunos";
$tituloFormulario1        = "Tabela com listagem de Portes de Alunos";
$descricaoFormulario1     = "Dados de identificação de portes de alunos";
$tituloImpressao          = "Relatório de portes de alunos cadastradas no sistema conectaideal";
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Portes</a>
          </li>
        </ul>
      </div>
    </div>
