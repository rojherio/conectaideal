...
$tituloPagina             = "Listagem de Tipos de Infraestrutura";
$descricaoPagina          = "Informações de tipos de infraestrutura";
$tituloFormulario1        = "Tabela com listagem de Tipos de Infraestrutura";
$descricaoFormulario1     = "Dados de identificação de tipos de infraestrutura";
$tituloImpressao          = "Relatório de tipos de infraestrutura cadastradas no sistema conectaideal";
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Tipos de Infraestrutura</a>
          </li>
        </ul>
      </div>
    </div>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/infraestrutura_tipo/listar.js"></script>