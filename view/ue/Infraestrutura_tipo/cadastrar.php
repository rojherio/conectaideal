...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_infraestrutura_tipo" name="form_infraestrutura_tipo" method="post" urltosend="ue/infraestrutura_tipo/salvar_identificacao" action="">
      <?php 
      include_once ('view/ue/infraestrutura_tipo/content_identificacao.php'); 
      ?>
    </form>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/infraestrutura_tipo/cadastrar.js"></script>