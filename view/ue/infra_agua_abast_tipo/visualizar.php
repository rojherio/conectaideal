...
if (empty($id)) {
  header('Location: '.PORTAL_URL.'view/ue/infra_agua_abast_tipo/listar');
}
...
$tituloPagina             = "Listagem do Tipo de Abastecimento de Água";
$descricaoPagina          = "Informações do tipo de abastecimento de agua";
$tituloFormulario1        = "Tabela informações do Tipo de Abastecimento de Água";
$descricaoFormulario1     = "Dados de informações do tipo de abastecimento de agua cadastrada no sistema conectaideal";
$tituloImpressao          = "Relatório de informações do tipo de abastecimento de agua cadastrada no sistema conectaideal";
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/infra_agua_abast_tipo/visualizar.js"></script>