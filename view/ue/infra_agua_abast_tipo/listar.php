...
$tituloPagina             = "Listagem de Tipos de Abastecimento de Água";
$descricaoPagina          = "Informações de tipos de abastecimento de agua";
$tituloFormulario1        = "Tabela com listagem de Tipos de Abastecimento de Água";
$descricaoFormulario1     = "Dados de identificação de tipos de abastecimento de agua";
$tituloImpressao          = "Relatório de tipos de abastecimento de agua cadastradas no sistema conectaideal";
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Tipos de Abastecimento de Água</a>
          </li>
        </ul>
      </div>
    </div>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/ue/infra_agua_abast_tipo/listar.js"></script>