...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_infra_agua_abast_tipo" name="form_infra_agua_abast_tipo" method="post" urltosend="ue/infra_agua_abast_tipo/salvar_identificacao" action="">
      <?php 
      include_once ('view/ue/infra_agua_abast_tipo/content_identificacao.php'); 
      ?>
    </form>
