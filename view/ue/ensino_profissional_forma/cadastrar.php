...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_ensino_profissional_forma" name="form_ensino_profissional_forma" method="post" urltosend="ue/ensino_profissional_forma/salvar_identificacao" action="">
      <?php 
      include_once ('view/ue/ensino_profissional_forma/content_identificacao.php'); 
      ?>
    </form>
