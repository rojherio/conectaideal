          ...
          <div divcount="<?=$keySD+1;?>" class="div_clonar row border border-outline-info rounded pt-3 pb-3 ps-1 pe-0 mt-3 mb-1 ms-0 me-0">
            ...
            <div class="row pe-0">
              ...
              <?= createSelect(array(
                ...
                /*bool*/      'required'    => false,
                /*string*/    'prop'        => 'idbase="sd_benef_bsc_municipio_id_" controlled="benef_'.$keySD.'" control-value="Sim" searchurl="bsc/municipio/get_municipios_estados" '
              )); ?>
            </div>
            <div class="row pe-0">
              <?= createSelect(array(
            ...
            <div controlled="repres_benef_<?=$keySD;?>" control-value="Sim" controlled-noshow="benef_<?=$keySD;?>" <?= $displayRepres ;?>>
              ...
              <div class="row pe-3">
                ...
                <?= createSelect(array(
                  ...
                  /*string*/    'ariaLabel'   => 'Digite o nome da cidade',
                  /*bool*/      'required'    => false,
                  /*string*/    'prop'        => 'idbase="sd_benef_repres_bsc_municipio_id_" controlled="repres_benef_'.$keySD.'" control-value="Sim" controlled-noshow="benef_'.$keySD.'" searchurl="bsc/municipio/get_municipios_estados" '
                )); ?>
              </div>
              <div class="row pe-3">
                <?= createInput(array(
