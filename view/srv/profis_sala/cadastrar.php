...
$stmt->bindValue(1, $id);
$stmt->execute();
$rsRegistroPS = $stmt->fetch(PDO::FETCH_ASSOC);
if (!($rsRegistroPS)) {
  $rsRegistroPS = array();
  $rsRegistroPS['id'] = 0;
}
//Consulta Base - END
//Parámetros de títutlos - BEGIN
$tituloPagina             = "Cadastro de Profissional de Sala";
$descricaoPagina          = "Informações de Profissional de sala";
        ...
        <div class="card-body equal-card">
          ...
          <div class="tab-content" id="v-bgContent">
            <div aria-labelledby="tab-pane-1" id="tab-pane-1" class="tab-pane fade <?= $tabPane <= 1 ? 'show active' : '' ;?>" role="tabpanel" tabindex="1">
              <form class="app-form" id="form_srv_identificacao" name="form_srv_identificacao" method="post" urlToSend="srv/profis_sala/salvar_identificacao" action="">
                <?php 
                include_once ('view/srv/profis_sala/content_identificacao.php'); 
                ?>
              </form>
            </div>
            <div aria-labelledby="tab-pane-2" id="tab-pane-2" class="tab-pane fade <?= $tabPane == 2 ? 'show active' : '' ;?>" role="tabpanel" tabindex="2">
              <form class="app-form" id="form_srv_contato" name="form_srv_contato" method="post" urlToSend="bsc/pessoa_fisica/salvar_contato" action="">
                <?php 
                include_once ('view/srv/profis_sala/content_contato.php'); 
                ?>
              </form>
            </div>
            <div aria-labelledby="tab-pane-3" id="tab-pane-3" class="tab-pane fade <?= $tabPane == 3 ? 'show active' : '' ;?>" role="tabpanel" tabindex="3">
              <form class="app-form" id="form_srv_documento" name="form_srv_documento" method="post" urlToSend="bsc/pessoa_fisica/salvar_documento" action="">
                <?php 
                include_once ('view/srv/profis_sala/content_documento.php'); 
                ?>
              </form>
            </div>
            <div aria-labelledby="tab-pane-4" id="tab-pane-4" class="tab-pane fade <?= $tabPane == 4 ? 'show active' : '' ;?>" role="tabpanel" tabindex="4">
              <form class="app-form" id="form_srv_instrucao" name="form_srv_instrucao" method="post" urlToSend="srv/profis_sala/salvar_instrucao" action="">
                <?php 
                include_once ('view/srv/profis_sala/content_instrucao.php'); 
                ?>
              </form>
            </div>
            <div aria-labelledby="tab-pane-4" id="tab-pane-5" class="tab-pane fade <?= $tabPane == 5 ? 'show active' : '' ;?>" role="tabpanel" tabindex="5">
              <form class="app-form" id="form_srv_formac_complemen" name="form_srv_formac_complemen" method="post" urlToSend="srv/profis_sala/salvar_formac_complemen" action="">
                <?php 
                include_once ('view/srv/profis_sala/content_formac_complemen.php'); 
                ?>
              </form>
            </div>
            <div aria-labelledby="tab-pane-4" id="tab-pane-6" class="tab-pane fade <?= $tabPane == 6 ? 'show active' : '' ;?>" role="tabpanel" tabindex="6">
              <form class="app-form" id="form_srv_formac_contin" name="form_srv_formac_contin" method="post" urlToSend="srv/profis_sala/salvar_formac_contin" action="">
                <?php 
                include_once ('view/srv/profis_sala/content_formac_contin.php'); 
                ?>
              </form>
            </div>
            <div aria-labelledby="tab-pane-5" id="tab-pane-7" class="tab-pane fade <?= $tabPane == 7 ? 'show active' : '' ;?>" role="tabpanel" tabindex="7">
              <form class="app-form" id="form_srv_familiar" name="form_srv_familiar" method="post" urlToSend="srv/profis_sala/salvar_familiar" action="">
                <?php 
                include_once ('view/srv/profis_sala/content_familiar.php'); 
                ?>
              </form>
            </div>
            <div aria-labelledby="tab-pane-6" id="tab-pane-8" class="tab-pane fade <?= $tabPane == 8 ? 'show active' : '' ;?>" role="tabpanel" tabindex="8">
              <form class="app-form" id="form_srv_dependente" name="form_srv_dependente" method="post" urlToSend="srv/profis_sala/salvar_dependente" action="">
                <?php 
                include_once ('view/srv/profis_sala/content_dependente.php'); 
                ?>
              </form>
            </div>
            <div aria-labelledby="tab-pane-7" id="tab-pane-9" class="tab-pane fade <?= $tabPane == 9 ? 'show active' : '' ;?>" role="tabpanel" tabindex="9">
              <form class="app-form" id="form_srv_bancario" name="form_srv_bancario" method="post" urlToSend="srv/profis_sala/salvar_bancario" action="">
                <?php 
                include_once ('view/srv/profis_sala/content_bancario.php'); 
                ?>
              </form>
            </div>
            <div aria-labelledby="tab-pane-8" id="tab-pane-10" class="tab-pane fade <?= $tabPane == 10 ? 'show active' : '' ;?>" role="tabpanel" tabindex="10">
              <form class="app-form" id="form_srv_contrato" name="form_srv_contrato" method="post" urlToSend="srv/profis_sala/salvar_contrato" action="">
                <?php 
                include_once ('view/srv/profis_sala/content_contrato.php'); 
                ?>
              </form>
            </div>
            <div aria-labelledby="tab-pane-9" id="tab-pane-11" class="tab-pane fade <?= $tabPane == 11 ? 'show active' : '' ;?>" role="tabpanel" tabindex="11">
              <form class="app-form" id="form_srv_vinculo" name="form_srv_vinculo" method="post" urlToSend="srv/profis_sala/salvar_vinculo" action="">
                <?php 
                include_once ('view/srv/profis_sala/content_vinculo.php'); 
                ?>
              </form>
            </div>
            <div aria-labelledby="tab-pane-10" id="tab-pane-12" class="tab-pane fade <?= $tabPane == 12 ? 'show active' : '' ;?>" role="tabpanel" tabindex="12">
              <form class="app-form" id="form_srv_obs" name="form_srv_obs" method="post" urlToSend="srv/profis_sala/salvar_obs" action="">
                <?php 
                include_once ('view/srv/profis_sala/content_obs.php'); 
                ?>
              </form>
            </div>
            <div aria-labelledby="tab-pane-11" id="tab-pane-13" class="tab-pane fade <?= $tabPane == 13 ? 'show active' : '' ;?>" role="tabpanel" tabindex="end">
              <form class="app-form" id="form_srv_saude" name="form_srv_saude" method="post" urlToSend="srv/profis_sala/salvar_saude" action="">
                <?php 
                include_once ('view/srv/profis_sala/content_saude.php'); 
                ?>
              </form>
            </div>
            <div aria-labelledby="tab-pane-ext-1" id="tab-pane-ext-1" class="tab-pane fade" role="tabpanel" tabindex="ext1">
              <form class="app-form" id="form_ext_sme_servidor" name="form_ext_sme_servidor" method="post" urlToSend="sme/servidor/salvar_identificacao" action="">
                <?php 
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/srv/profis_sala/cadastrar.js"></script>