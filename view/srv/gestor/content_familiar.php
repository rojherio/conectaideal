...
$stmt = $db->prepare("
  SELECT 
  id,
  CONCAT(nome, ' - ', nacionalidade) AS nome
  FROM bsc_pais 
  WHERE id IN (?)
  ORDER BY id ASC;");
$stmt->bindValue(1, $rsRegistroSFamiliar['bsc_pais_id_conjuge']);
$stmt->execute();
...
<?php
if (!in_array($rsRegistroPessoaIdent['bsc_estado_civil_id'], [1]) ) {
  ?>
  <div class="row">
    <input type="hidden" name="pf_id" id="pf_id" value="<?= $rsRegistroSFamiliar['id'] ;?>">
    <input type="hidden" name="sf_sme_servidor_id" id="sf_sme_servidor_id" value="<?= $idS ;?>">
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="row">
            <?= createSelect(array(
              ...
              /*bool*/      'required'    => false,
              /*string*/    'prop'        => 'controller="naturalidade_conjuge" controller-values="0|1" searchurl="bsc/pais/get_nacionalidades" '
            )); ?>
            <?php
          ...
          //Parámetros de exibir/ocultar div - NED
            ...
            <?= createSelect(array(
              ...
              /*bool*/      'required'    => false,
              /*string*/    'prop'        => 'controlled="naturalidade_conjuge" control-value="1" searchurl="bsc/municipio/get_municipios_estados" '
            )); ?>
          </div>
      ...
      <div class="card-body">
        ...
        <div class="row">
          <?= createRadio(array(
            ...
            /*bool*/      'required'    => false,
            /*string*/    'prop'        => 'controller="cert_mod_antigo" controller-values="Antigo"'
          )) ?>
          <?= createInput(array(
            /*int 1-12*/  'col'         => 7,
            ...
            /*string*/    'class'       => 'form-control '.($rsRegistroSFamiliar['reg_civil_modelo'] == 'Novo' ? 'mask-certidao-novo' : ' '),
            /*int*/       'minlength'   => 1,
            /*int*/       'maxlength'   => 37,
        ...
        <div class="row">
          ...
          <?= createSelect(array(
            /*int 1-12*/  'col'         => 7,
            /*string*/    'label'       => 'Cidade de Expedição da Certidão',
        ...
        <?php
        //Parámetros de exibir/ocultar div - BEGIN
        $displayCertidaoAntiga        = $rsRegistroSFamiliar['reg_civil_modelo'] != 'Antigo' ? 'style="display: none;"' : '';
        //Parámetros de exibir/ocultar div - NED
        ?>
        <div controlled="cert_mod_antigo" control-value="Antigo" <?= $displayCertidaoAntiga ;?>>
          <div class="row">
            <?= createInput(array(
              /*int 1-12*/  'col'         => 4,
              ...
              /*bool*/      'required'    => false,
              /*string*/    'prop'        => 'controlled="cert_mod_antigo" control-value="Antigo"'
            )) ;?>
            <?= createInput(array(
              /*int 1-12*/  'col'         => 3,
...
<?php
if (in_array($rsRegistroPessoaIdent['bsc_estado_civil_id'], [5]) ) {
  ?>
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="row">
            ...
            <?= createSelect(array(
              /*int 1-12*/  'col'         => 6,
              /*string*/    'label'       => 'Cidade de Expedição da Averbação',
