...
$stmt = $db->prepare("SELECT 
  ...
  FROM eo_uo AS u
  LEFT JOIN eo_uo_tipo AS ut ON ut.id = u.eo_uo_tipo_id
  ORDER BY ut.nome");
$stmt->execute();
$rsRegistros = $stmt->fetchAll(PDO::FETCH_ASSOC);
//Consulta para DataTable - END
//Parámetros de títutlos - BEGIN
$tituloPagina             = "Listagem de Unidades Organizacional";
$descricaoPagina          = "Informações de unidades organizacional";
$tituloFormulario1        = "Tabela com listagem de Unidades Organizacional";
$descricaoFormulario1     = "Dados de identificação de unidades organizacional";
$tituloImpressao          = "Relatório de unidades organizacional cadastradas no sistema conectaideal";
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Unidades Organizacional</a>
          </li>
        </ul>
      </div>
    </div>
              ...
              <!-- <table id="table_modelo_01" class="display app-data-table default-data-table"> -->
                <table id="table_listar" class="table table-striped display app-data-table">
                  <thead class="bg-inverse">
                    <tr>
                      <th>#</th>
                      <th>Tipo de Unidade Organizacional</th>
                      <th>Nome</th>
                      <th>Status</th>
                  ...
                  <tbody>
                    ...
                    foreach ($rsRegistros as $kObj => $vObj) {
                      ...
                      <tr>
                        ...
                        <td id="td_uo_tipo_nome"><?= $vObj['uo_tipo_nome']; ?></td>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/eo/uo/listar.js"></script>