...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_uo" name="form_uo" method="post" urltosend="eo/uo/salvar_identificacao" action="">
      <?php 
      include_once ('view/eo/uo/content_identificacao.php'); 
      ?>
    </form>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/eo/uo/cadastrar.js"></script>