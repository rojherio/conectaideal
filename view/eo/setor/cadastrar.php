...
<main>
  <div class="container-fluid">
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Cargo</a>
          </li>
        </ul>
      </div>
    </div>
    ...
    <form class="app-form" id="form_turno" name="form_turno" method="post" urltosend="eo/cargo/salvar_identificacao" action="">
      <?php 
      include_once ('view/eo/cargo/content_identificacao.php'); 
      ?>
    </form>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/eo/cargo/cadastrar.js"></script>