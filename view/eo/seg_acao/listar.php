...
$tituloPagina             = "Listagem de Ações";
$descricaoPagina          = "Informações de ações";
$tituloFormulario1        = "Tabela com listagem de Ações";
$descricaoFormulario1     = "Dados de identificação de ações";
$tituloImpressao          = "Relatório de ações cadastradas no sistema conectaideal";
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Ações</a>
          </li>
        </ul>
      </div>
    </div>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/eo/seg_acao/listar.js"></script>