...
<main>
  <div class="container-fluid">
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Ação</a>
          </li>
        </ul>
      </div>
    </div>
    ...
    <form class="app-form" id="form_acao" name="form_acao" method="post" urltosend="eo/seg_acao/salvar_identificacao" action="">
      <?php 
      include_once ('view/eo/seg_acao/content_identificacao.php'); 
      ?>
    </form>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/eo/seg_acao/cadastrar.js"></script>