...
$stmt = $db->prepare("SELECT 
  ...
  pa.caminho,
  pa.seg_pasta_id,
  p.nome AS seg_pasta_nome
  FROM seg_pagina AS pa
  LEFT JOIN seg_pasta AS p ON p.id = pa.seg_pasta_id
  ORDER BY pa.nome");
$stmt->execute();
$rsRegistros = $stmt->fetchAll(PDO::FETCH_ASSOC);
//Consulta para DataTable - END
//Parámetros de títutlos - BEGIN
$tituloPagina             = "Listagem de Pagina";
$descricaoPagina          = "Informações de pagina";
$tituloFormulario1        = "Tabela com listagem de Pagina";
$descricaoFormulario1     = "Dados de identificação de pagina";
$tituloImpressao          = "Relatório de pagina cadastradas no sistema conectaideal";
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Pagina</a>
          </li>
        </ul>
      </div>
    </div>
                  ...
                  <tbody>
                    ...
                    foreach ($rsRegistros as $kObj => $vObj) {
                      ...
                      <tr>
                        ...
                        <td id="td_pasta"><?= $vObj['seg_pasta_nome']; ?></td>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/eo/seg_pagina/listar.js"></script>