...
$descricaoPagina          = "Informações da Pagina";
...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_seg_pagina" name="form_seg_pagina" method="post" urltosend="eo/seg_pagina/salvar_identificacao" action="">
      <?php 
      include_once ('view/eo/seg_pagina/content_identificacao.php'); 
      ?>
    </form>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/eo/seg_pagina/cadastrar.js"></script>