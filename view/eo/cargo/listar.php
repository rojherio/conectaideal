...
$tituloPagina             = "Listagem de Cargos";
$descricaoPagina          = "Informações de cargos";
$tituloFormulario1        = "Tabela com listagem de Cargos";
$descricaoFormulario1     = "Dados de identificação de cargos";
$tituloImpressao          = "Relatório de cargos cadastradas no sistema conectaideal";
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Cargos</a>
          </li>
        </ul>
      </div>
    </div>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/eo/cargo/listar.js"></script>