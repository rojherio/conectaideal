...
$stmt = $db->prepare("SELECT 
  ...
  p.caminho,
  p.seg_submodulo_id,
  sm.nome AS seg_submodulo_nome
  FROM seg_pasta AS p
  LEFT JOIN seg_modulo AS sm ON sm.id = p.seg_submodulo_id
  ORDER BY p.nome");
$stmt->execute();
$rsRegistros = $stmt->fetchAll(PDO::FETCH_ASSOC);
//Consulta para DataTable - END
//Parámetros de títutlos - BEGIN
$tituloPagina             = "Listagem de Pasta";
$descricaoPagina          = "Informações de pasta";
$tituloFormulario1        = "Tabela com listagem de Pasta";
$descricaoFormulario1     = "Dados de identificação de pasta";
$tituloImpressao          = "Relatório de pasta cadastradas no sistema conectaideal";
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Pastas</a>
          </li>
        </ul>
      </div>
    </div>
                  ...
                  <tbody>
                    ...
                    foreach ($rsRegistros as $kObj => $vObj) {
                      ...
                      <tr>
                        ...
                        <td id="td_modulo"><?= $vObj['seg_submodulo_nome']; ?></td>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/eo/seg_pasta/listar.js"></script>