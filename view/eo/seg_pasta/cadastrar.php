...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_seg_pasta" name="form_seg_pasta" method="post" urltosend="eo/seg_pasta/salvar_identificacao" action="">
      <?php 
      include_once ('view/eo/seg_pasta/content_identificacao.php'); 
      ?>
    </form>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/eo/seg_pasta/cadastrar.js"></script>