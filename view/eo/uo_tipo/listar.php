...
$tituloPagina             = "Listagem de Tipos de Unidade Organizacional";
$descricaoPagina          = "Informações de tipos de unidade organizacional";
$tituloFormulario1        = "Tabela com listagem de Tipos de Unidade Organizacional";
$descricaoFormulario1     = "Dados de identificação de tipos de unidade organizacional";
$tituloImpressao          = "Relatório de tipos de unidade organizacional cadastradas no sistema conectaideal";
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">Tipos de Unidade Organizacional</a>
          </li>
        </ul>
      </div>
    </div>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/eo/uo_tipo/listar.js"></script>