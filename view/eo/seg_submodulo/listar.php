...
$stmt = $db->prepare("SELECT 
  ...
  sm.caminho,
  sm.seg_modulo_id,
  m.nome AS seg_modulo_nome
  FROM seg_submodulo AS sm
  LEFT JOIN seg_modulo AS m ON m.id = sm.seg_modulo_id
  ORDER BY sm.nome");
$stmt->execute();
$rsRegistros = $stmt->fetchAll(PDO::FETCH_ASSOC);
//Consulta para DataTable - END
//Parámetros de títutlos - BEGIN
$tituloPagina             = "Listagem de SubModulos";
$descricaoPagina          = "Informações de submodulos";
$tituloFormulario1        = "Tabela com listagem de SubModulos";
$descricaoFormulario1     = "Dados de identificação de submodulos";
$tituloImpressao          = "Relatório de submodulos cadastradas no sistema conectaideal";
    ...
    <div class="row m-1">
      <div class="col-12 ">
        ...
        <ul class="app-line-breadcrumbs mb-3">
          ...
          <li class="active">
            <a href="<?= PORTAL_URL; ?>" class="f-s-14 f-w-500">SubModulos</a>
          </li>
        </ul>
      </div>
    </div>
                  ...
                  <tbody>
                    ...
                    foreach ($rsRegistros as $kObj => $vObj) {
                      ...
                      <tr>
                        ...
                        <td id="td_modulo"><?= $vObj['seg_modulo_nome']; ?></td>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/eo/seg_submodulo/listar.js"></script>