...
<main>
  <div class="container-fluid">
    ...
    <form class="app-form" id="form_modulo" name="form_modulo" method="post" urltosend="eo/seg_modulo/salvar_identificacao" action="">
      <?php 
      include_once ('view/eo/seg_modulo/content_identificacao.php'); 
      ?>
    </form>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/eo/seg_modulo/cadastrar.js"></script>