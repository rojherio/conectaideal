...
if (empty($id)) {
  header('Location: '.PORTAL_URL.'view/eo/seg_modulo/listar');
}
...
$tituloPagina             = "Listagem do Modulo";
$descricaoPagina          = "Informações do modulo";
$tituloFormulario1        = "Tabela informações do Modulo";
$descricaoFormulario1     = "Dados de informações do modulo cadastrada no sistema conectaideal";
$tituloImpressao          = "Relatório de informações do modulo cadastrada no sistema conectaideal";
            ...
            <div class="app-datatable-default overflow-auto">
              ...
              <table id="table_visualizar" class="table table-striped display app-data-table">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>Pasta</td>
                    <td><?= $rsRegistro['pasta']; ?></td>
                  </tr>
                  <tr>
                    <td>Caminho</td>
                    <td><?= $rsRegistro['caminho']; ?></td>
                  </tr>
                </tbody>
...
?>
<script type="text/javascript" src="<?= PORTAL_URL; ?>control/eo/seg_modulo/visualizar.js"></script>