...
$id                                       = strip_tags(@$_POST['m_id']?: '');
$status                                   = strip_tags(@$_POST['m_status']?: 0);
$dt_cadastro                              = date("Y-m-d H:i:s");
$nome                                     = ucwords(strtolower(trim(strip_tags(@$_POST['m_nome']?: ''))));
$descricao                                = trim(strip_tags(@$_POST['m_descricao']?: ''));
$pasta                                    = trim(strip_tags(@$_POST['m_pasta']?: ''));
$caminho                                  = trim(strip_tags(@$_POST['m_caminho']?: ''));
