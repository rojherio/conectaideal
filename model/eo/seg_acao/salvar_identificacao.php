...
$id                                       = strip_tags(@$_POST['a_id']?: '');
$status                                   = strip_tags(@$_POST['a_status']?: 0);
$dt_cadastro                              = date("Y-m-d H:i:s");
$nome                                     = ucwords(strtolower(trim(strip_tags(@$_POST['a_nome']?: ''))));
$descricao                                = trim(strip_tags(@$_POST['a_descricao']?: ''));
$tableName      = 'seg_acao';
$error          = false;
$result         = array();
$msg            = "";
