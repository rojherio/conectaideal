...
$id                                       = strip_tags(@$_POST['ca_id']?: '');
$status                                   = strip_tags(@$_POST['ca_status']?: 0);
$dt_cadastro                              = date("Y-m-d H:i:s");
$nome                                     = ucwords(strtolower(trim(strip_tags(@$_POST['ca_nome']?: ''))));
$tableName      = 'bsc_categoria_administrativa';
$error          = false;
$result         = array();
$msg            = "";
