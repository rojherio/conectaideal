...
$id                                       = strip_tags(@$_POST['sp_id']?: '');
$status                                   = strip_tags(@$_POST['sp_status']?: 0);
$dt_cadastro                              = date("Y-m-d H:i:s");
$nome                                     = ucwords(strtolower(trim(strip_tags(@$_POST['sp_nome']?: ''))));
$descricao                                = trim(strip_tags(@$_POST['sp_descricao']?: ''));
$tableName      = 'bsc_setor_publico';
$error          = false;
$result         = array();
$msg            = "";
