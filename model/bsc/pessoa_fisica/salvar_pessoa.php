...
$natural_estrangeiro_cidade               = ucwords(strtolower(strip_tags(@$_POST['p_natural_estrangeiro_cidade']?: '')));
$natural_estrangeiro_estado               = ucwords(strtolower(strip_tags(@$_POST['p_natural_estrangeiro_estado']?: '')));
$natural_estrangeiro_condicao_trabalho    = ucwords(strtolower(strip_tags(@$_POST['p_natural_estrangeiro_condicao_trabalho']?: '')));
$pai_nome                                 = ucwords(strtolower(strip_tags(@$_POST['p_pai_nome']?: '')));
$pai_natural_bsc_pais_id                  = strip_tags(@$_POST['p_pai_natural_bsc_pais_id']?: '');
$pai_profissao                            = ucwords(strtolower(strip_tags(@$_POST['p_pai_profissao']?: '')));
$mae_nome                                 = ucwords(strtolower(strip_tags(@$_POST['p_mae_nome']?: '')));
$mae_natural_bsc_pais_id                  = strip_tags(@$_POST['p_mae_natural_bsc_pais_id']?: '');
$mae_profissao                            = ucwords(strtolower(strip_tags(@$_POST['p_mae_profissao']?: '')));
$foto                                     = "";
$sangue_tipo                              = strip_tags(@$_POST['p_sangue_tipo']?: '');
$raca                                     = ucwords(strtolower(strip_tags(@$_POST['p_raca']?: '')));
$enfermedade_portador                     = ucwords(strtolower(strip_tags(@$_POST['p_enfermedade_portador']?: '')));
