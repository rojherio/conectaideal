...
$id                                       = strip_tags(@$_POST['ilof_id']?: '');
$status                                   = strip_tags(@$_POST['ilof_status']?: 0);
$dt_cadastro                              = date("Y-m-d H:i:s");
$nome                                     = ucwords(strtolower(trim(strip_tags(@$_POST['ilof_nome']?: ''))));
$descricao                                = trim(strip_tags(@$_POST['ilof_descricao']?: ''));
$tableName      = 'ue_infra_local_ocupacao_forma';
$error          = false;
$result         = array();
$msg            = "";
// sleep(10);
