...
$id                                       = strip_tags(@$_POST['iar_id']?: '');
$status                                   = strip_tags(@$_POST['iar_status']?: 0);
$dt_cadastro                              = date("Y-m-d H:i:s");
$nome                                     = ucwords(strtolower(trim(strip_tags(@$_POST['iar_nome']?: ''))));
$descricao                                = trim(strip_tags(@$_POST['iar_descricao']?: ''));
$tableName      = 'ue_infra_acessib_recurso';
$error          = false;
$result         = array();
$msg            = "";
// sleep(10);
