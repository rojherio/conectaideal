...
$id                                       = strip_tags(@$_POST['pcf_id']?: '');
$status                                   = strip_tags(@$_POST['pcf_status']?: 0);
$dt_cadastro                              = date("Y-m-d H:i:s");
$nome                                     = ucwords(strtolower(trim(strip_tags(@$_POST['pcf_nome']?: ''))));
$descricao                                = trim(strip_tags(@$_POST['pcf_descricao']?: ''));
$tableName      = 'ue_parc_conv_forma';
$error          = false;
$result         = array();
$msg            = "";
// sleep(10);
