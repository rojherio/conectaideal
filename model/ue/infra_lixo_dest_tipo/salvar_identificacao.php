...
$id                                       = strip_tags(@$_POST['ildt_id']?: '');
$status                                   = strip_tags(@$_POST['ildt_status']?: 0);
$dt_cadastro                              = date("Y-m-d H:i:s");
$nome                                     = ucwords(strtolower(trim(strip_tags(@$_POST['ildt_nome']?: ''))));
$descricao                                = trim(strip_tags(@$_POST['ildt_descricao']?: ''));
$tableName      = 'ue_infra_lixo_dest_tipo';
$error          = false;
$result         = array();
$msg            = "";
