...
$id                                       = strip_tags(@$_POST['ipt_id']?: '');
$status                                   = strip_tags(@$_POST['ipt_status']?: 0);
$dt_cadastro                              = date("Y-m-d H:i:s");
$nome                                     = ucwords(strtolower(trim(strip_tags(@$_POST['ipt_nome']?: ''))));
$descricao                                = trim(strip_tags(@$_POST['ipt_descricao']?: ''));
$tableName      = 'ue_internet_pub_tipo';
$error          = false;
$result         = array();
$msg            = "";
// sleep(10);
