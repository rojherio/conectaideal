...
$id                                       = strip_tags(@$_POST['ief_id']?: '');
$status                                   = strip_tags(@$_POST['ief_status']?: 0);
$dt_cadastro                              = date("Y-m-d H:i:s");
$nome                                     = ucwords(strtolower(trim(strip_tags(@$_POST['ief_nome']?: ''))));
$descricao                                = trim(strip_tags(@$_POST['ief_descricao']?: ''));
$tableName      = 'ue_infra_eletrica_fonte';
$error          = false;
$result         = array();
$msg            = "";
