...
$id                                       = strip_tags(@$_POST['ilrtt_id']?: '');
$status                                   = strip_tags(@$_POST['ilrtt_status']?: 0);
$dt_cadastro                              = date("Y-m-d H:i:s");
$nome                                     = ucwords(strtolower(trim(strip_tags(@$_POST['ilrtt_nome']?: ''))));
$descricao                                = trim(strip_tags(@$_POST['ilrtt_descricao']?: ''));
$tableName      = 'ue_infra_lixo_resid_trat_tipo';
$error          = false;
$result         = array();
$msg            = "";
