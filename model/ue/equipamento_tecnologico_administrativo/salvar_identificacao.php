...
$id                                       = strip_tags(@$_POST['eta_id']?: '');
$status                                   = strip_tags(@$_POST['eta_status']?: 0);
$dt_cadastro                              = date("Y-m-d H:i:s");
$nome                                     = ucwords(strtolower(trim(strip_tags(@$_POST['eta_nome']?: ''))));
$descricao                                = trim(strip_tags(@$_POST['eta_descricao']?: ''));
$tableName      = 'ue_equip_tecn_administrativo';
$error          = false;
$result         = array();
$msg            = "";
