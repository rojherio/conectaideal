...
$id                                       = strip_tags(@$_POST['pmt_id']?: '');
$status                                   = strip_tags(@$_POST['pmt_status']?: 0);
$dt_cadastro                              = date("Y-m-d H:i:s");
$nome                                     = ucwords(strtolower(trim(strip_tags(@$_POST['pmt_nome']?: ''))));
$descricao                                = trim(strip_tags(@$_POST['pmt_descricao']?: ''));
$tableName      = 'ue_priv_mantenedora_tipo';
$error          = false;
$result         = array();
$msg            = "";
