...
$id                                       = strip_tags(@$_POST['eaia_id']?: '');
$status                                   = strip_tags(@$_POST['eaia_status']?: 0);
$dt_cadastro                              = date("Y-m-d H:i:s");
$nome                                     = ucwords(strtolower(trim(strip_tags(@$_POST['eaia_nome']?: ''))));
$descricao                                = trim(strip_tags(@$_POST['eaia_descricao']?: ''));
$tableName      = 'ue_equip_acesso_internet_aluno';
$error          = false;
$result         = array();
$msg            = "";
// sleep(10);
