...
$id                                       = strip_tags(@$_POST['erlt_id']?: '');
$status                                   = strip_tags(@$_POST['erlt_status']?: 0);
$dt_cadastro                              = date("Y-m-d H:i:s");
$nome                                     = ucwords(strtolower(trim(strip_tags(@$_POST['erlt_nome']?: ''))));
$descricao                                = trim(strip_tags(@$_POST['erlt_descricao']?: ''));
$tableName      = 'ue_equip_rede_local_tipo';
$error          = false;
$result         = array();
$msg            = "";
