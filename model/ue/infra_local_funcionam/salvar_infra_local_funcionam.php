...
$id                                       = strip_tags(@$_POST['ilf_id']?: '');
$status                                   = strip_tags(@$_POST['ilf_status']?: 0);
$dt_cadastro                              = date("Y-m-d H:i:s");
$nome                                     = ucwords(strtolower(trim(strip_tags(@$_POST['ilf_nome']?: ''))));
$descricao                                = trim(strip_tags(@$_POST['ilf_descricao']?: ''));
$tableName      = 'ue_infra_local_funcionam';
$error          = false;
$result         = array();
$msg            = "";
// sleep(10);
