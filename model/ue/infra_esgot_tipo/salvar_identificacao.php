...
$id                                       = strip_tags(@$_POST['iet_id']?: '');
$status                                   = strip_tags(@$_POST['iet_status']?: 0);
$dt_cadastro                              = date("Y-m-d H:i:s");
$nome                                     = ucwords(strtolower(trim(strip_tags(@$_POST['iet_nome']?: ''))));
$descricao                                = trim(strip_tags(@$_POST['iet_descricao']?: ''));
$tableName      = 'ue_infra_esgot_tipo';
$error          = false;
$result         = array();
$msg            = "";
