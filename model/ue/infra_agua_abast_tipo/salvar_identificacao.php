...
$id                                       = strip_tags(@$_POST['iaat_id']?: '');
$status                                   = strip_tags(@$_POST['iaat_status']?: 0);
$dt_cadastro                              = date("Y-m-d H:i:s");
$nome                                     = ucwords(strtolower(trim(strip_tags(@$_POST['iaat_nome']?: ''))));
$descricao                                = trim(strip_tags(@$_POST['iaat_descricao']?: ''));
$tableName      = 'ue_infra_agua_abast_tipo';
$error          = false;
$result         = array();
$msg            = "";
