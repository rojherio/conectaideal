...
$id                                       = strip_tags(@$_POST['ept_id']?: '');
$status                                   = strip_tags(@$_POST['ept_status']?: 0);
$dt_cadastro                              = date("Y-m-d H:i:s");
$nome                                     = ucwords(strtolower(trim(strip_tags(@$_POST['ept_nome']?: ''))));
$descricao                                = trim(strip_tags(@$_POST['ept_descricao']?: ''));
$tableName      = 'ue_ens_profis_tipo';
$error          = false;
$result         = array();
$msg            = "";
// sleep(10);
