...
$id                                       = strip_tags(@$_POST['rs_id']?: '');
$status                                   = strip_tags(@$_POST['rs_status']?: 0);
$dt_cadastro                              = date("Y-m-d H:i:s");
$nome                                     = ucwords(strtolower(trim(strip_tags(@$_POST['rs_nome']?: ''))));
$descricao                                = trim(strip_tags(@$_POST['rs_descricao']?: ''));
$tableName      = 'ue_regulam_situacao';
$error          = false;
$result         = array();
$msg            = "";
// sleep(10);
