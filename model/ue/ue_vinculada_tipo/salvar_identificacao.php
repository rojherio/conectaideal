...
$id                                       = strip_tags(@$_POST['uvt_id']?: '');
$status                                   = strip_tags(@$_POST['uvt_status']?: 0);
$dt_cadastro                              = date("Y-m-d H:i:s");
$nome                                     = ucwords(strtolower(trim(strip_tags(@$_POST['uvt_nome']?: ''))));
$descricao                                = trim(strip_tags(@$_POST['uvt_descricao']?: ''));
$tableName      = 'ue_ue_vinculada_tipo';
$error          = false;
$result         = array();
$msg            = "";
