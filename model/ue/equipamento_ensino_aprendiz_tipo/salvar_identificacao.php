...
$id                                       = strip_tags(@$_POST['eeat_id']?: '');
$status                                   = strip_tags(@$_POST['eeat_status']?: 0);
$dt_cadastro                              = date("Y-m-d H:i:s");
$nome                                     = ucwords(strtolower(trim(strip_tags(@$_POST['eeat_nome']?: ''))));
$descricao                                = trim(strip_tags(@$_POST['eeat_descricao']?: ''));
$tableName      = 'ue_equip_ens_aprendiz_tipo';
$error          = false;
$result         = array();
$msg            = "";
