...
$id                                       = strip_tags(@$_POST['fp_id']?: '');
$status                                   = strip_tags(@$_POST['fp_status']?: 0);
$dt_cadastro                              = date("Y-m-d H:i:s");
$nome                                     = ucwords(strtolower(trim(strip_tags(@$_POST['fp_nome']?: ''))));
$descricao                                = trim(strip_tags(@$_POST['fp_descricao']?: ''));
$tableName      = 'ue_funcao_tipo';
$error          = false;
$result         = array();
$msg            = "";
