...
$id                                       = strip_tags(@$_POST['st_id']?: '');
$status                                   = strip_tags(@$_POST['st_status']?: 0);
$dt_cadastro                              = date("Y-m-d H:i:s");
$nome                                     = ucwords(strtolower(trim(strip_tags(@$_POST['st_nome']?: ''))));
$descricao                                = trim(strip_tags(@$_POST['st_descricao']?: ''));
$tableName      = 'sme_rh_serv_tipo';
$error          = false;
$result         = array();
$msg            = "";
