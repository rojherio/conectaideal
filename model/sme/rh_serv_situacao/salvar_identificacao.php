...
$id                                       = strip_tags(@$_POST['ss_id']?: '');
$status                                   = strip_tags(@$_POST['ss_status']?: 0);
$dt_cadastro                              = date("Y-m-d H:i:s");
$nome                                     = ucwords(strtolower(trim(strip_tags(@$_POST['ss_nome']?: ''))));
$descricao                                = trim(strip_tags(@$_POST['ss_descricao']?: ''));
$tableName      = 'sme_rh_serv_situacao';
$error          = false;
$result         = array();
$msg            = "";
